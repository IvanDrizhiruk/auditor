...
public class InspectionResourceIntTest {
    ...
    public static Inspection createEntity() {
        ...
        inspection.setCompanyId(DEFAULT_COMPANY_ID);
    ...
    public void createInspection() throws Exception {
        ...
        assertThat(testInspection.getCompanyId()).isEqualTo(DEFAULT_COMPANY_ID);
    ...
    public void updateInspection() throws Exception {
        ...
        assertThat(testInspection.getCompanyId()).isEqualTo(UPDATED_COMPANY_ID);
